...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.type == HMSegmentedControlTypeText || self.type == HMSegmentedControlTypeFixed) {
...
- (void)updateSegmentsRects {
    ...
    if ((self.type == HMSegmentedControlTypeText || self.type == HMSegmentedControlTypeFixed) && self.segmentWidthStyle == HMSegmentedControlSegmentWidthStyleFixed) {
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if (CGRectContainsPoint(enlargeRect, touchLocation)) {
        ...
        } else if (self.type == HMSegmentedControlTypeTextImages || self.type == HMSegmentedControlTypeText || self.type == HMSegmentedControlTypeFixed) {
