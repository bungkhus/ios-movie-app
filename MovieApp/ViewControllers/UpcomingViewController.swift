...
class UpcomingViewController: UIViewController {
    ...
    var refreshed = false
    let interactor = UpcomingInteractor(perPage: 20, storeKey: "Upcoming")
...
extension UpcomingViewController: DZNEmptyDataSetSource, DZNEmptyDataSetDelegate {
...
extension UpcomingViewController: SBSearchBarDelegate {
